...
const game = (() => {
  ...
  const renderText = (optional = "") => {
    ...
    gameRenderText.textContent = textOutput;
  };
  ...
  const renderStatistics = () => {
    ...
    player1Draws.textContent = player1.getDraws();
    player1Lost.textContent = player1.getLost();
    player2Wins.textContent = player2.getWins();
    player2Draws.textContent = player2.getDraws();
    player2Lost.textContent = player2.getLost();
  };
    ...
    for (let i = 0; i < board.length; i++) {
      ...
      for (let j = 0; j < board[i].length; j++) {
        ...
        if (
          ...
          (previousIteration === "" && currentIteration === "") ||
          previousIteration != playerSign ||
          currentIteration != playerSign
        ) {
          winner = false;
          break;
        }
